...
const FeaturesForm = () => {
	...
	return (
		<div className="p-5 my-4 border">
			<h3 className="text-center text-lg font-bold pb-5 lg:pb-10">Add your property features</h3>
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				/>
				<div className="lg:flex items-center justify-start gap-6 space-y-3 lg:space-y-0">
					<FormField
						control={control}
